...
<head>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/views/baseDataMgr/majorMgr/majorManager.js"></script>
</head>
<body style="margin:1px;">
<table id="dg" title="专业信息管理" class="easyui-datagrid" fitColumns="true"
       pagination="true" rownumbers="true"
       data-options="
           fitColumns:true,
           scrollbarSize:1,
           striped:true"
       url="${pageContext.request.contextPath}/common/dataGrid?table=v_major" fit="true"
       toolbar="#tb">
    <thead>
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="majorName" width="50" align="center">专业名称</th>
        <th field="departmentName" width="50" align="center">所属学院</th>
